...
public class WelcomePage extends BasePageObject {
    ...
    private By fromAuthenticationLinkLocator=By.linkText("Form Authentication");
   ...
   public void openPage(){
    ...
    public LoginPage clickFormAuthenticationLink(){
        ...
        click(fromAuthenticationLinkLocator);
        return new LoginPage(driver,log);
    }

    /** Open Checkboxes by clicking on Checkboxes Link*/
